      ...
      <div class="row gy-4">
        <div class="col-lg-5 col-md-12 footer-about">
          <a href="{{ route('home') }}" class="logo d-flex align-items-center">
            <span>Shoker Bagan</span>
          </a>
          <p>we believe in the transformative power of gardens to enrich lives, foster connections with nature, and create lasting beauty. Through our platform, we invite you to explore, connect, and collaborate with us. </p>
