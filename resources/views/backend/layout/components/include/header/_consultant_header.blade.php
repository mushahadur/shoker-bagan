      ...
      <nav class="header-nav ms-auto">
        <ul class="d-flex align-items-center">
          ...
          <li class="nav-item dropdown pe-3">
            ...
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="{{route('user.dashboard')}}" data-bs-toggle="dropdown">
              @if (Auth::user()->image)
              <img src="{{ asset('/storage/consultant/profile-images/' .Auth::user()->image) }}" alt="Profile" class="rounded-circle">
              @else
              <img src="{{ asset('/') }}assets/frontend/img/default_profile.png" alt="Profile" class="rounded-circle">
              @endif
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
              ...
              <li>
                <a class="dropdown-item d-flex align-items-center" href="{{route('consultant.profile')}}">
