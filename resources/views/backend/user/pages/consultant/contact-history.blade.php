...
@section('title')
    User Consultant Contact History
@endsection
@section('contain')
    <div class="pagetitle">
        <h1>User Consultant Contact History</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item">Pages</li>
                <li class="breadcrumb-item active">Consultant Contact History</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Consultant Contact History <span>| Today</span></h5>
